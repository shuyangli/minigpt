...
def load_weights_and_hyperparams(model_path: Path, load_weights: bool = True) -> tuple[Hyperparams, ModelParams]:
...
def main():
    ...
    hyperparams, model_params = load_weights_and_hyperparams(model_path, load_weights=True)
